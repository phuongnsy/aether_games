...
# a property on. `lantern_tests_TESTS` is the list doctest publishes for
...
foreach(lantern_test IN LISTS lantern_tests_TESTS)
  set_tests_properties("${lantern_test}" PROPERTIES LABELS headless)
endforeach()
